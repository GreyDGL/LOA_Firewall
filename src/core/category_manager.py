...
class CategoryManager:
    ...
    def __init__(self, config):
        ...
        """
        self.unified_categories = config.get("categories", {}).get(
    ...
    def get_category_info(self, category_key):
        ...
        """
        return self.unified_categories.get(
            category_key, {"code": "UNKNOWN", "description": "Unknown category", "severity": 1}
        )
    ...
    def _resolve_two_guard_conflicts(self, guard_results):
        ...
        # Rule 4: If both unsafe → report reason based on llama guard
            ...
            return {
                ...
                "conflicting_categories": (
                    [granite_category] if granite_category != llama_category else []
                ),
                "llama_category": llama_category,
                "granite_category": granite_category,
                "selected_model": llama_result.get("model", "llama-guard"),
    ...
    def _resolve_by_highest_severity(self, categories):
        ...
        return {
            ...
            "conflicting_categories": [
                cat["category"] for cat in categories if cat["category"] != selected["category"]
            ],
        ...
        for cat in categories:
            if cat["category"] != "safe":
                return {
                    ...
                    "conflicting_categories": [
                        c["category"] for c in categories if c["category"] != cat["category"]
                    ],
