...
class KeywordFilter:
    ...
    def _load_default_blacklist(self):
        ...
        self.blacklist = {
            "keywords": [
                "hack", "exploit", "bypass security", "illegal", "steal password",
                "malware", "phishing", "ransomware", "keylogger"
            ],
            "regex_patterns": [
                r"(\b|_)password(\b|_)",
                r"(\b|_)ssh[_-]key(\b|_)",
    ...
    def _compile_patterns(self):
        ...
        self.compiled_patterns = [re.compile(pattern, re.IGNORECASE)
                                  for pattern in self.blacklist["regex_patterns"]]
    ...
    def check_content(self, text):
        ...
        reason = "Content contains blacklisted terms" if not is_safe else "Content passed keyword filter"
